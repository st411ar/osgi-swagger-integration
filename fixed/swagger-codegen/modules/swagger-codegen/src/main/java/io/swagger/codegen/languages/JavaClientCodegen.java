                   ...
                   GzipFeatures
{
    ...
    public JavaClientCodegen() {
        ...
        supportedLibraries.put(RETROFIT_2 + "-custom", "Fixed retrofit2 library. HTTP client: OkHttp 3.8.0. JSON processing: Gson 2.6.1 (Retrofit 2.3.0). Enable the RxJava adapter using '-DuseRxJava[2]=true'. (RxJava 1.x or 2.x)");
